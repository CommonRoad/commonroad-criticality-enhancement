...
scenario_path1 = PROJECT_ROOT / "scenarios" / "DEU_Lohmar-32_1_T-1.xml"
...
scenario_path5 = PROJECT_ROOT / "scenarios" / "DEU_Flensburg-94_1_T-1.xml"
...
# Run the following to approximately run the scenarios for same time
